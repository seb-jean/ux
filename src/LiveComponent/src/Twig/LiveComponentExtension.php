        ...
        return [
            new TwigFunction('component_url', [LiveComponentRuntime::class, 'getComponentUrl'], [
                ...(class_exists(DeprecatedCallableInfo::class)
                    ? ['deprecation_info' => new DeprecatedCallableInfo('symfony/ux-live-component', '3.2', 'ux_live_component_url')]
                    : ['deprecated' => '3.2', 'deprecating_package' => 'symfony/ux-live-component', 'alternative' => 'ux_live_component_url']),
            ]),
            ...
            new TwigFunction('live_action', [LiveComponentRuntime::class, 'liveAction'], [
                'is_safe' => ['html_attr'],
                ...(class_exists(DeprecatedCallableInfo::class)
                    ? ['deprecation_info' => new DeprecatedCallableInfo('symfony/ux-live-component', '3.2', 'ux_live_action')]
                    : ['deprecated' => '3.2', 'deprecating_package' => 'symfony/ux-live-component', 'alternative' => 'ux_live_action']),
            ]),
